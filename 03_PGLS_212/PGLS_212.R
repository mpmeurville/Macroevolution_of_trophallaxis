...
my_tree <- read.tree('D://re-do_V2/00_dataset_production/output/tree_212.tre') # For Newick format trees
...
### 212 sp
cl = read.csv("D://re-do_V2/01_Dtest_211sp_all_traits/input/clonal_212.txt", sep = "\t")
colnames(cl)[2] = "cl"
liq = read.csv("D://re-do_V2/01_Dtest_211sp_all_traits/input/liq_212.txt", sep = "\t")
colnames(liq)[2] = "liq"
ova = read.csv("D://re-do_V2/01_Dtest_211sp_all_traits/input/ova_212.txt", sep = "\t")
colnames(ova)[2] = "ova"
spe = read.csv("D://re-do_V2/01_Dtest_211sp_all_traits/input/sperm_212.txt", sep = "\t")
colnames(spe)[2] = "spe"
st = read.csv("D://re-do_V2/01_Dtest_211sp_all_traits/input/sting_212.txt", sep = "\t")
colnames(st)[2] = "st"
tro = read.csv("D://re-do_V2/01_Dtest_211sp_all_traits/input/troph_212.txt", sep = "\t")
colnames(tro)[2] = "tro"
gam = read.csv("D://re-do_V2/01_Dtest_211sp_all_traits/input/GamOvSt_212.txt", sep = "\t")
colnames(gam)[2] = "gam"
siz = read.csv("D://re-do_V2/01_Dtest_211sp_all_traits/input/col_212.txt", sep = "\t")
colnames(siz)[2] = "siz"
...
pdf("D://re-do_V2/03_PGLS_212/output/model_plot_ScsTG.pdf", height = 12, width = 12)
